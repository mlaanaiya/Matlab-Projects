...
I_decorrelee = I;
Premiere_Colonne = I_decorrelee(:,1);
I_droite = I_decorrelee(:,2:end);
I_gauche = I_decorrelee(:,1:end-1);
I_decorrelee = [ Premiere_Colonne , I_droite - I_gauche ];
% Pour visualiser I_decorrelee au lieu de I
I = I_decorrelee; 
